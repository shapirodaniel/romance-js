...
function generatePoem(wordCorpus, numLines) {
  ...
  for (let i = 0; i < numLines; i++) {
    // random line length generation
    poem += writeLine(mChain, Math.floor(Math.random() * 10));
  }

  return "*----- This poem was generated by a Markov process -----*\n\n" + poem;
}
...
const myPoem = generatePoem(allPoems, 10);
